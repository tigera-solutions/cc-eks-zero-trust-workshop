# AWS Dev Days: Hands-on EKS workshop </br> Implementing zero-trust security for containers
...
Module 2 - [Deploy an AWS EKS cluster](/modules/module-2-deploy-aks.md)  
